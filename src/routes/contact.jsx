...
const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Talk to NM Infrastructure about your construction project. Call, email or send us your brief for a free consultation." },
...
function ContactPage() {
  ...
  const info = [
    ...
    { icon: Phone, title: "Call Us", lines: ["+91 98765 43210", "+91 22 4000 8000"] },
    { icon: Mail, title: "Email", lines: ["hello@nminfra.com", "projects@nminfra.com"] },
  ...
  return <>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {info.map((i, idx) => <div key={i.title} className="bg-white border border-border p-6 hover:border-primary transition reveal" data-delay={idx * 100}>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10 items-start">
          <div className="reveal-left">
            ...
            {sent ? <div className="bg-primary/20 border border-primary p-6 font-display">
  ...
  >
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <input required type="email" placeholder="Email address" className="w-full bg-muted border border-border px-4 py-3 focus:outline-none focus:border-primary transition" />
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  <input placeholder="Phone number" className="w-full bg-muted border border-border px-4 py-3 focus:outline-none focus:border-primary transition" />
