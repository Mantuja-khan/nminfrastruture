...
import { MapPin, Phone, ArrowRight, FileText } from "lucide-react";
import logoImg from "@/assets/logo.png";
import logoAsset from "@/assets/nm-logo.png.asset.json";

function SiteFooter() {
  return (
    <footer className="bg-[var(--dark)] text-white/70 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-14 grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
        <div className="lg:pr-4">
          ...
          <div className="text-xs leading-relaxed mb-5 space-y-1.5 text-white/60 border border-white/10 bg-white/[0.03] p-4">
            <div className="flex items-start gap-2">
              ...
              <span>
                GSTIN: <span className="text-white/85">08EJTPK5240J2ZN</span>
              </span>
            </div>
            <div>
              Legal Name: <span className="text-white/85">Arshad Khan</span>
            </div>
        ...
        <div>
          <h4 className="text-white font-display font-bold uppercase tracking-widest text-sm mb-5 relative pb-3 after:absolute after:left-0 after:bottom-0 after:w-10 after:h-0.5 after:bg-primary">
            Quick Links
          </h4>
          <ul className="space-y-3 text-sm">
            {[
              ...
              <li key={l.to}>
                <Link
                  to={l.to}
                  className="hover:text-primary transition inline-flex items-center gap-2 group"
                >
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            {["Residential", "Commercial", "Industrial", "Renovation", "Consulting"].map((s) => (
              <li key={s}>
                <span className="hover:text-primary transition cursor-pointer">{s}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex gap-3">
              ...
              <span>
                Shop No. 04, Yunus Colony,
                <br />
                Teh. Tapukara, Near Ashirwad Company,
                <br />
                Gadpur, Khairthal Tijara,
                <br />
                Rajasthan 301707
              </span>
            </li>
            <li className="flex gap-3">
              ...
              <a href="tel:+919887211937" className="hover:text-primary">
                +91 9887211937
              </a>
            </li>
          </ul>
      ...
      <div className="relative max-w-7xl mx-auto px-6 mt-14 py-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-3 text-xs">
        <div>© {new Date().getFullYear()} NM Infrastructure. All rights reserved.</div>
